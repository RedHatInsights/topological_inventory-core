class AddNotNullConstraintsToAllModels < ActiveRecord::Migration[5.1]
  def up
    ...
    change_column :service_parameters_sets, :source_id, :bigint, :null => false
    ...
    change_column :service_parameters_sets, :tenant_id, :bigint, :null => false
  ...
  def down
    ...
    change_column :service_parameters_sets, :source_id, :bigint, :null => true
    ...
    change_column :service_parameters_sets, :tenant_id, :bigint, :null => true
