class AddTimestampsForParallelSaving < ActiveRecord::Migration[5.1]
  def change
    ...
    add_column :service_parameters_sets, :resource_timestamp, :datetime
    ...
    add_column :service_parameters_sets, :resource_timestamps, :jsonb, :default => {}
    ...
    add_column :service_parameters_sets, :resource_timestamps_max, :datetime
  end
end
